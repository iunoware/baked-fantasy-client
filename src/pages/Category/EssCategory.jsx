      ...
      <section className="lg:pt-30 md:pt-20 pt-40 bg">
        ...
        <section className="whyChooseUs flex justify-center pb-8 lg:px-20 md:px-15 sm:px-10 px-5">
          <div className="bg-white shadow-xl rounded-2xl">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 pb-10 px-8">
              <div className="card-1 flex flex-col  items-center text-center">
                <dotlottie-wc
                  src="https://lottie.host/d4619c31-8233-4fea-ad44-64c815a9938b/k6GT8peJ1X.lottie"
              ...
              <div className="card-2 flex flex-col  items-center text-center">
                <dotlottie-wc
                  src="https://lottie.host/bf62354b-942b-439e-86a0-189d26847c0e/GOTCABmoDK.lottie"
                  style={{ width: "300px", height: "300px" }}
                  speed="0.5"
                  autoplay
                  loop
              ...
              <div className="card-3 flex flex-col  items-center text-center">
                <dotlottie-wc
                  src="https://lottie.host/315dd76f-54ca-433d-a37c-ed0205a5cb28/4wrUoUBfgS.lottie"
                  style={{ width: "300px", height: "300px" }}
                  speed="1"
                  autoplay
                  loop
        ...
        <section className="bulk-orders overflow-hidden m-8 rounded-2xl bg-gray-50 sm:grid sm:grid-cols-2 sm:items-center">
          ...
          <img
            alt=""
            src="/images/bulk-2.png"
            className="h-full w-full object-cover object-top-left sm:h-[calc(100%_-_2rem)] sm:self-end sm:rounded-ss-[30px] md:h-100 md:rounded-ss-[60px]"
          />
        </section>
      </section>
    </>
