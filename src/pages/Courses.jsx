      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-12">
        ...
        <div className="m-12 lg:ml-40">
          <div className="relative overflow-hidden bg-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl border-0 group">
            ...
            <div className="p-8 pb-6">
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-sky-500 mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
                <Laptop strokeWidth={2} size={32} color="#ffffff" />
              </div>
              <div className="text-2xl font-bold text-center text-gray-900">
                Online Courses
              </div>
              <div className="text-center text-gray-600 text-lg mt-3">
            ...
            <div className="p-8 pt-2">
              ...
              <Link
                ...
                className="w-full block bg-sky-500 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Join Online
              </Link>
            </div>
        ...
        <div className="m-12 lg:mr-40">
          <div className="relative overflow-hidden bg-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl border-0 group">
            ...
            <div className="p-8 pb-6">
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-sky-500 mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
                <GraduationCap strokeWidth={2} size={32} color="#ffffff" />
              </div>
              <div className="text-2xl font-bold text-center text-gray-900">
                Offline Courses
              </div>
              <div className="text-center text-gray-600 text-lg mt-3">
                Experience in-person training with expert instructors.
              </div>
            </div>
            <div className="p-8 pt-2">
              <div className="space-y-4 mb-8">
