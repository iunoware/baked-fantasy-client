    ...
    <>
      ...
      <div>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4 lg:gap-8 md:m-12 sm:m-4 m-4">
          <div class=" rounded flex flex-col place-items-center bg-gray-300">
            <svg
              width="64px"
              height="64px"
              viewBox="0 0 1024 1024"
            ...
            <h3 className="text-2xl text-center">Flexible Online & Offline Learning</h3>
