...
import { Laptop, GraduationCap, Heading } from "lucide-react";
import Headings from "../components/Heading.jsx";
// due to "Heading" spell conflict with lucide react I import it as "Headings"
  ...
  return (
    <div className="bg">
      ...
      <div className="pt-15 md:pt-5">
        <h1 className="lg:text-6xl md:text-5xl sm:text-4xl lora text-3xl flex font-semibold justify-center pt-30">
          Choose our <span className="text-pbrown">&nbsp;Learning path</span>
          {/* <Headings title={"Choose our Learning path"} /> */}
        </h1>
