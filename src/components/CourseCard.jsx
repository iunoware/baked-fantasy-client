function CourseCard(props) {
  ...
  return (
    <>
      <div className="bg-gray-200 hover:ring-blue-400 hover:ring-2 hover:ring-offset-2 rounded-2xl group hover:scale-101 hover:shadow-xl transition-all duration-200 my-10">
        <div className="relative">
          ...
          <div className={`${randomColor} absolute inset-0 rounded-t-2xl`}></div>
          ...
          <div className="absolute inset-0 h-full w-full flex flex-col justify-end">
            ...
            <p className="text-white text-lg ml-10 mb-10">
