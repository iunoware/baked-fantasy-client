        ...
        <div className="lg:w-[60vw] lg:h-[85vh] md:w-[60vw] md:h-[68.2vh] w-screen h-screen  rounded-2xl bg-[url(/images/padded.png)] bg-pink-400 p-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 h-screen md:h-fit items-center lg:grid-cols-2 gap-0">
            ...
            <div className="flex-1 flex items-center justify-center p-8">
              <div className="w-full max-w-md border-1 rounded-2xl  border-white inset-shadow-white inset-shadow-sm backdrop-blur-xs ">
                  ...
                  <CardContent className="p-8">
                    ...
                    <form className="space-y-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          type="button"
                          className="text-sm text-black font-bold hover:text-white transition-colors"
                        >
                          Forgot password?
                        </button>
                      </div>
