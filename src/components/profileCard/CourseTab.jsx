  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      {courses.map((purchasedCourse, index) => {
        ...
        const fallbackImage = "https://images.unsplash.com/photo-1608986596619-eb50cc56831f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBsZWFybmluZyUyMGVkdWNhdGlvbnxlbnwxfHx8fDE3NjA0MTIwMjd8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral";
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 w-full space-y-3 px-1">
              <h4 className="text-gray-900 font-bold text-base line-clamp-2 md:line-clamp-1 pr-2">{title}</h4>

              <div className="space-y-2 max-w-sm">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Course Progress</span>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} className="mt-2 md:mt-0 self-start md:self-auto w-full md:w-auto">
